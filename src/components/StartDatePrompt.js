...
export default function StartDatePrompt({setStartDate}) {
    ...
    return (
        <>
            ...
            <button className='h-fit w-fit max-w-[320px] p-3 text-gray-300 border-gray-200 bg-[#203F8A] rounded-lg dark:bg-gray-700' onClick={handleSubmit}>Confirm Date</button>
            </div>
